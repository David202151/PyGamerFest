...
class DashboardRepository
{
    ...
    public function __construct(RoleRepository $roleRepo, UserRepository $userRepo, PermissionRepository $permissionRepo, AttendanceRepository $attendanceRepo,JugadorRepository $jugadoresRepo, EquipoRepository $equipoRepo,CategoriaRepository $categoriasRepo, AulaRepository $aulasRepo  )
